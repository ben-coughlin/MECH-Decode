...
//import android.os.SystemClock; // ALEJANDRO
import org.firstinspires.ftc.simteamcode.SystemClock; // ALEJANDRO

//import com.qualcomm.robotcore.eventloop.opmode.Autonomous; // ALEJANDRO
...
public class AutoSummerPinPoint extends RobotMasterPinpoint {
    ...
    private static final String SIMULATOR_HOST = "192.168.43.170";
...
//    public void mainLoop() {
//
////        super.loop(); // ALEJANDRO: why the original never call loop()???
//
//        boolean jamDetected = false;//pixelJamAndCounting();
//        telemetry.addData("Superstructure State", currentState);
//        telemetry.addData("Path State", programStage);
...
//            if (Movement.followCurve(points, Math.toRadians(0),2)) {
//                drive.stopAllMovementDirectionBased();
//                nextStage(progStates.strafeRight.ordinal());  // ALEJANDRO
//
//                //nextStage(progStates.endBehavior.ordinal());
//            }
//
